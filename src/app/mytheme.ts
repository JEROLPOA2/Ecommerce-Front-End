...
export const MyTheme = definePreset(Lara, {
  ...
  semantic: {
    ...
    anchorGutter: '2px',
    primary: {
      50: '#fffafa', // ~95% blanco / 5% base
      100: '#fef5f5', // ~90% blanco / 10% base
      200: '#fde6e6', // ~75% blanco / 25% base
      300: '#fbd7d7', // ~60% blanco / 40% base
      400: '#fac8c8', // ~45% blanco / 55% base
      500: '#f59b9b', // color base
      600: '#dd8c8c', // ~90% base / 10% negro
      700: '#c47c7c', // ~80% base / 20% negro
      800: '#ac6d6d', // ~70% base / 30% negro
      900: '#935d5d', // ~60% base / 40% negro
      950: '#7b4e4e', // ~50% base / 50% negro
    },
    formField: {
      paddingX: '0.75rem',
      paddingY: '0.625rem',
      ...
      colorScheme: {
        ...
        dark: {
          ...
          outlined: {
            ...
            help: {
              hoverBackground:
                'color-mix(in srgb, {help.400}, transparent 96%)',
              activeBackground:
                'color-mix(in srgb, {help.400}, transparent 84%)',
